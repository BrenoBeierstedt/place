...
exports.postAPIPixel = (req, res, next) => {
    ...
    function paintWithUser(user) {
        ...
        var x = Number.parseInt(req.body.x), y = Number.parseInt(req.body.y), spray_name = req.body.spray_name, metadata= req.body.metadata, spray_img = req.body.spray_img ;
        ...
        req.place.paintingManager.doPaint(rgb, x, y, user, spray_name, metadata,spray_img).then((pixel) => {
