...
exports.identifyAPIUser = (req, res, next) => {
    ...
    if (!req.body.wallet || !req.body.password) return res.status(400).json({ success: false, error: { message: "A username and password are required.", code: "invalid_parameters" } });
